...
This exercise implements a 3×3 experimental design to evaluate LLM performance on legislative bill classification:
...
**Live Deployment**: [INFO 4940/5940 Tutor Chatbot](https://019aa31e-982f-17f6-37c8-55b3193c9b63.share.connect.posit.cloud)
...
**Framework**: Built with Shiny for Python using the chatlas library

**Model**: GPT-4.1 for high-quality, accurate responses
...
The chatbot will explain the 3×3 experimental design, discuss prompt engineering strategies, and suggest testing on small samples first - without writing the code for the student.
